...
class Product(models.Model):
    ...
    Product_num = models.FloatField("Product number", default=0, editable=False)

    # Router specified properties:

    Material = models.CharField('Material', max_length=127, blank=True)
    # e.g. Atheros AR9344. Blank value stands for unknown.

    Style = models.CharField('Style', max_length=127, blank=True)
    # e.g. AR9344. Blank value stands for unknown.

    Shoulder = models.IntegerField("Shoulder",default=0,
                                    validators=[MinValueValidator(1)])
    Waist = models.IntegerField('Waist',default=0,
                                    validators=[MinValueValidator(0)])
    Chest = models.IntegerField('Chest', default=0,
                                    validators=[MinValueValidator(0)])
    Fashion_element = models.CharField(max_length=127, blank=True)
    # e.g. 802.11b/g/n/ac. Blank value stands for not supported.

    Picture  = models.CharField(max_length=127, blank=True)
    # e.g. 12 VDC, 2 A. Blank value stands for unknown.

    Has_waitband = models.BooleanField('Has waistband', default=False)
