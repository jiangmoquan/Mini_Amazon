...
class Truck(models.Model):
    ...
    wh_id = models.ForeignKey(Warehouse)
...
class Order(models.Model):
    ...
    delivery_x = models.IntegerField(default=0)
    delivery_y = models.IntegerField(default=0)
    truck_id = models.IntegerField(null=True)
    wh_id = models.ForeignKey(Warehouse,null=True)
    tracking_num = models.IntegerField(null=True)
